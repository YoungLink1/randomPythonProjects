...
# Start of Global Pygame Related Functions:
def poll_mouse(value=int()):
        """Uses the pygame.mouse.get_pressed function and gives an easier to read and use output of where the mouse is or what mouse buttons are pressed. Supports 3 & 5 button mice.
...
if DEBUG_testItem == 1:
    ...
    # pygame.QUIT event means the user clicked X to close your window
        ...
        poly_LMB = [(45, 90), (45, 0), (33.75, 2.25), (24.75, 6.75), (15.75, 13.5), (9, 24.75), (3.6, 38.25), (0.9, 58.5), (0, 90)]
        poly_RMB = [(45, 90), (45, 0), (56.25, 2.25), (65.25, 6.75), (74.25, 13.5), (81, 24.75), (86.4, 38.25), (89.1, 58.5), (90, 90)]
        poly_MMB = [(38, 15), (52, 15), (52, 55), (38, 55)]
